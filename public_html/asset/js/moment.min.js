! function (e, t) {
	...
	var We = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
		He = "ژانویه_فوریه_مارس_آوریل_مه_ژوئن_ژولای_آگوست_سپتامبر_اوکتبر_نوامبر_دسامبر".split("_");
	var Re = "ژان_فور_مار_آور_مه_ژوئن_ژول_آگو_سپت_اوک_نوا_دسا".split("_");
	...
	var je = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنجشنبه_جمعه_شنبه".split("_");
	var Ze = "یکش_دوش_سشن_چها_پنج_جمع_شنب".split("_");
